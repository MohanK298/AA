...
{
    /// <summary>
    /// Description of taxCalc_Single_Activity.
    /// </summary>
    [TestModule("25C305AB-5A63-4256-A22A-FCE47BA07ADB", ModuleType.UserCode, 1)]
    public class taxCalc_Single_Activity : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public taxCalc_Single_Activity()
        {
    	...
    	string fileName="SingleActivity_file"+System.DateTime.Now.ToString();
    	...
    	private void CreateBillforTE()
    	{
        	...
        	taxAmt=(tax1+tax2)*fees/100;
     		...
     		Validate.AttributeContains(file.BillingDetailForm.PnlDraftSummary.txtDraftTaxesInfo,"Text",taxAmt.ToString(),string.Format("Taxes value is {0} and is the correct calculated amount",taxAmt.ToString()));
