...
{
    /// <summary>
    /// Description of account_receivable_report_validation.
    /// </summary>
    [TestModule("AD35FD5A-B3EC-4F04-B8E3-C1905B63BCBF", ModuleType.UserCode, 1)]
    public class account_receivable_report_validation : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public account_receivable_report_validation()
        {
        ...
        string[] columnNames={"Client ID","Client","Phone Number","Client Matter ID","Resp. Lwyr.","File Type","File Name","AR Date","Invoice #","Fee Lwyr.","Total Billed","Current","31 - 60","61 - 90","91 - 120",">121 Days","Totals","Trust","General Retainer"};
        string[] summaryDetails={"Firm Totals","Client Totals","Summary by Fee Credit Lawyer","AU","Summary by File Type","Summary by Responsible Lawyer"};
        
        private void account_receivable_report_Validation()
        {
        	string enabled="";
        	string todayDate="";
        ...
        void ITestModule.Run()
        {
            ...
            account_receivable_report_Validation();
        }
    }
}
