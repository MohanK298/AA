...
{
    /// <summary>
    /// Description of trust_bank_journal_report_save.
    /// </summary>
    [TestModule("1FB22E17-531F-406B-AC34-44F1ED2B9705", ModuleType.UserCode, 1)]
    public class trust_bank_journal_report_save : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public trust_bank_journal_report_save()
        {
        ...
        private void trust_Bank_Journal_report_Save()
        {
        	string todayDate="";
        ...
        void ITestModule.Run()
        {
            ...
            trust_Bank_Journal_report_Save();
        }
    }
}
