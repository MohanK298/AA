...
{
    /// <summary>
    /// Description of client_payment_distirbution_default_values_validation.
    /// </summary>
    [TestModule("CE452AE5-0076-46B5-9BF2-10211F61872E", ModuleType.UserCode, 1)]
    public class client_payment_distirbution_default_values_validation : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public client_payment_distirbution_default_values_validation()
        {
        ...
        private void client_Payment_Dist_Default_Values_Validation()
        {
        	int lstcount=0;
        	...
        	if(report.SQLReportForm.SelfInfo.Exists(60000))
        	{
        		...
        		Validate.AttributeContains(report.SQLReportForm.PnlBase.txt_ClPayStartDateInfo,"UIAutomationValueValue","","From Date Value is empty as expected");
        ...
        void ITestModule.Run()
        {
            ...
            client_Payment_Dist_Default_Values_Validation();
        }
    }
}
