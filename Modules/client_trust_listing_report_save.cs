...
{
    /// <summary>
    /// Description of client_trust_listing_report_save.
    /// </summary>
    [TestModule("31E8D869-884D-43B3-A658-0E8E97011B60", ModuleType.UserCode, 1)]
    public class client_trust_listing_report_save : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public client_trust_listing_report_save()
        {
        ...
        private void client_trust_listing_report_Save()
        {
        ...
        void ITestModule.Run()
        {
            ...
            client_trust_listing_report_Save();
        }
    }
}
