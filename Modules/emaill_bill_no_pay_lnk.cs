...
{
    /// <summary>
    /// Description of emaill_bill_no_pay_lnk.
    /// </summary>
    [TestModule("10BB7EB2-62E7-447C-81E6-14AC3F79CBDC", ModuleType.UserCode, 1)]
    public class emaill_bill_no_pay_lnk : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public emaill_bill_no_pay_lnk()
        {
    	...
    	private void validateOutlookDraft()
    	{
        	...
        	if(outlook.Outlook.MailFolders.DraftsInfo.Exists(15000))
        	{
