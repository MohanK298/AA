...
{
    /// <summary>
    /// Description of clientTransaction_report_Validation.
    /// </summary>
    [TestModule("D60695A7-760C-4832-AF64-C988D5BF22AE", ModuleType.UserCode, 1)]
    public class clientTransaction_report_Validation : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public clientTransaction_report_Validation()
        {
        ...
        string[] columnNames={"Client ID","Client ","Client Matter ID","Resp. Lawyer","File","Date","Details","Fee","Expense","Tax","Interest","Receipts","Inv #","Acct #","Trust Receipt","Trust Check","Balance","Audit","Description"};
        string[] summaryDetails={"File Totals","Firm Totals","Unbilled","Billed","AR","Hrs","Fees","Expenses","Taxes","Interest","Trust","Retainer"};
        private void clientTransactionsReportViewer()
        {
        	string todayDate="";
        ...
        void ITestModule.Run()
        {
            ...
            clientTransactionsReportViewer();
        }
    }
}
