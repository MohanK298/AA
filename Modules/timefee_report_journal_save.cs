...
{
    /// <summary>
    /// Description of timefee_report_journal_save.
    /// </summary>
    [TestModule("F4F4C184-C710-475C-8AAF-8C8D30269BF5", ModuleType.UserCode, 1)]
    public class timefee_report_journal_save : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public timefee_report_journal_save()
        {
        ...
        private void timeFeeJorunalReportViewerSave()
        {
        	string todayDate="";
        ...
        void ITestModule.Run()
        {
            ...
            timeFeeJorunalReportViewerSave();
        }
    }
}
