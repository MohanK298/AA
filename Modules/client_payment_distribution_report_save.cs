...
{
    /// <summary>
    /// Description of client_payment_distribution_report_save.
    /// </summary>
    [TestModule("50AFD313-3AEC-4A24-B062-49F33A6F4FF2", ModuleType.UserCode, 1)]
    public class client_payment_distribution_report_save : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public client_payment_distribution_report_save()
        {
        ...
        private void client_Payment_Distribution_report_Save()
        {
        ...
        void ITestModule.Run()
        {
            ...
            client_Payment_Distribution_report_Save();
        }
    }
}
