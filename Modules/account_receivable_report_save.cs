...
{
    /// <summary>
    /// Description of account_receivable_report_save.
    /// </summary>
    [TestModule("A867AA30-74B7-44D6-B83E-50372444C273", ModuleType.UserCode, 1)]
    public class account_receivable_report_save : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public account_receivable_report_save()
        {
        ...
        private void account_Receivable_report_Save()
        {
        	string todayDate="";
        ...
        void ITestModule.Run()
        {
            ...
            account_Receivable_report_Save();
        }
    }
}
