...
{
    /// <summary>
    /// Description of bill_Creation_no_primary_email.
    /// </summary>
    [TestModule("2C00AD73-DFFF-46BC-B98F-BE45BF71FC2A", ModuleType.UserCode, 1)]
    public class bill_Creation_no_primary_email : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public bill_Creation_no_primary_email()
        {
        ...
        string lastName="BlankMailContact";
    	...
    	private void AddFile()
    	{
        	...
        	if(file.PeopleSelectForm.SelfInfo.Exists(3000))
        	{
        		...
        		file.FindContactsForm.txtFindContact.PressKeys(lastName+time);
