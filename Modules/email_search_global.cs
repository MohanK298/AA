...
{
	/// <summary>
	/// Description of email_search_global.
	/// </summary>
	[TestModule("6F39AF70-17B8-4D06-BB10-13F7385F5277", ModuleType.UserCode, 1)]
	public class email_search_global : ITestModule
	{
		/// <summary>
		/// Constructs a new instance.
		/// </summary>
		public email_search_global()
		{
		...
		private void email_search()
		{
			...
			if(comm.Search.SelfInfo.Exists(3000))
			{
				...
				if(comm.SearchResult.SelfInfo.Exists(10000))
				{
					...
					Validate.AttributeContains(comm.SearchResult.PnlBase.txtShowingFieldInfo,"Text",type,"Showing Fields is displayed correctly");
