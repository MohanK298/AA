...
{
    /// <summary>
    /// Description of client_accounting_ledger_report_validation.
    /// </summary>
    [TestModule("4EA54E4D-FD45-4C95-B006-0E9D669C59F5", ModuleType.UserCode, 1)]
    public class client_accounting_ledger_report_validation : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public client_accounting_ledger_report_validation()
        {
    	...
    	string[] columnNames={"Date","Ref #","Hours","Fees","Expenses","Payments","Interests","Tax","Bill / WIP","Balance"};
        string[] summaryDetails={"Subtotal","Total"};
       
        private void Client_Account_Ledger_Report_Validation()
        {
        ...
        void ITestModule.Run()
        {
            ...
            Client_Account_Ledger_Report_Validation();
        }
    }
}
