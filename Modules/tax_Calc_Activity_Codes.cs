...
{
    /// <summary>
    /// Description of tax_Calc_Activity_Codes.
    /// </summary>
    [TestModule("701A7880-4B5B-47BF-A299-4E792F1239DF", ModuleType.UserCode, 1)]
    public class tax_Calc_Activity_Codes : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public tax_Calc_Activity_Codes()
        {
    	...
    	private void CreateBillforMultipleTE()
    	{
        	...
        	taxAmt=(tax1+tax2)*fees/100 - ((tax1+tax2)*fees/300);
     		tval=fees+taxAmt;
     		...
     		Validate.AttributeContains(file.BillingDetailForm.PnlDraftSummary.txtDraftTaxesInfo,"Text",taxAmt.ToString(),string.Format("Taxes value is {0} and is the correct calculated amount for 3 Time Entries and 2 TE with sales tax amount",taxAmt.ToString()));
