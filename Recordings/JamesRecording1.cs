...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Run application 'C:\\Amicus\\Amicus Attorney Premium Workstation\\AmicusAttorney.XWin.exe' with arguments '' in normal mode.", new RecordItemIndex(0));
